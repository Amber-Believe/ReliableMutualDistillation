...
#from lib.train.p_train_meanteacher import Trainer
#from lib.train.trainer import Trainer
#from lib.train.p_train_original import Trainer
from lib.train.p_train_our_ACDC import Trainer
...
def main():
    ...
    training_generator_weak, val_generator ,_= medical_loaders.generate_datasets(args,
                path='/home/qwang/Desktop/code/datasets/ACDC/noisy_0.6/')

    model1 = Unet(1, 4)
    model2 = Unet(1, 4)


    #optimizer1 = optim.Adam(list(model1.parameters()) + list(model2.parameters()), 1e-3)
...
def get_arguments():
    ...
    parser.add_argument('--consist_factor', type=float, default=0.8)
    parser.add_argument('--consistency_rampup', type=int, default=10)
    parser.add_argument('--consistency', type=float, default=1)  #default=100.0
    parser.add_argument('--batchSz', type=int, default=10)  #default=4
    parser.add_argument('--dataset_name', type=str, default="ACDC")
    parser.add_argument('--nEpochs', type=int, default=50)  #default=250
    ...
    parser.add_argument('--log_dir', type=str,
                        default='../runs/')
    parser.add_argument('--noise_rate', type=float, help='corruption rate, should be less than 1', default=0.004)
